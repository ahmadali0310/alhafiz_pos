            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="form-group">
                            <label><strong><?php echo e(trans('file.Size')); ?></strong></label>
                            <input type="number" name="edit_size" class="form-control" step="any">
                        </div>
                        <div class="form-group">
...
<script type="text/javascript">
    ...
    //
    //     checkQuantity($(this).val(), size, true);
    ...
    //     rowindex = $(this).closest('tr').index();
    //     var qty = $(".qty").val();
    //     console.log("This is Quantity: "+qty);
    //
    ...
    // $('select[name="status"]').on("change", function() {
    //     var payment_status = $(this).val();
    //     if (payment_status == 3 || payment_status == 4 || payment_status == 2 || payment_status == 1) {
    ...
    $("#myTable").on('input', '.qty', function() {
        rowindex = $(this).closest('tr').index();
        var size = $(this).closest('tr').find('td input.size').val() * 1;
        var qty = $(this).closest('tr').find('.qty').val();
        $('input[name="edit_qty"]').val(qty);
        var size = $(this).closest('tr').find('.size').val();
        $('input[name="edit_size"]').val(size);
    ...
    $('button[name="update_btn"]').on("click", function() {
        ...
        var edit_size = $('input[name="edit_size"]').val();
        ...
        checkQuantity(edit_qty, edit_size, false);
    });

    $(document).ready(function(){
        $(document).on('keypress', '.size', function (e) {    
