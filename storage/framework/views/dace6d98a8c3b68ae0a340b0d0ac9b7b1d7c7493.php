                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            <label><strong><?php echo e(trans('file.sale_type')); ?> *</strong></label>
                                            <select required id="sale_type" name="sale_type" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select Sale Type...">
                                                <option value="SALE"><?php echo e(trans('file.Sale')); ?></option>
                                                <option value="WHOLE_SALE"><?php echo e(trans('file.Add Sale')); ?></option>
...
<script type="text/javascript">
   ...
   var product_type = [];
    ...
    $("#myTable").on('input', '.qty', function() {
        ...
        calculateRowProductData($(this).val(), size, saleType);
    });
    ...
    $("#myTable").on('change', '.size', function() {
        ...
        var saleType = $('#sale_type').val();
        calculateRowProductData(qty, $(this).val(), saleType);

    });

    $("#myTable").on('input', '.unit_price', function() {
        rowindex = $(this).closest('tr').index();


        // if(typeof parseFloat( $(this).val()))

        product_price[rowindex] = parseFloat( $(this).val());
        var qty = $(this).closest('tr').find('td input.qty').val() * 1;
        $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('.net_unit_price').val($(this).val());
        var size = $(this).closest('tr').find('td select.size').val() * 1;
        ...
        calculateRowProductData(qty , size);
        // calculateGrandTotal();
...
//                        var saleType = $('#sale_type').val();
//
//                        calculateRowProductData(qty, size, saleType);
//                        flag = 0;
//                    }
//                });
                ...
                if(flag){
                    ...
                    cols += '<td><input type="number" class="form-control unit_price" step="any" required/></td>';
                    ...
                    var saleType = $('#sale_type').val();
                    calculateRowProductData(1, initialSize, saleType);
                }  
            }
        });
    }
    ...
    function calculateRowProductData(quantity, size, saleType) {
        var row_product_code = $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('td:nth-child(2)').text();
        ...
        $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('.unit_price').val((product_discount[rowindex] * quantity).toFixed(2));
        ...
        if (tax_method[rowindex] == 1) {
            ...
            if(saleType == 'SALE'){
                ...
                console.log("Sale"+sub_cost);

            } else {
                var sub_total = (net_unit_price * (quantity * size)) + tax;
                var sub_cost = (net_unit_cost * (quantity*size));
                console.log("Whole"+net_unit_price);
            }

            $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('.unit_price').val(net_unit_price);
