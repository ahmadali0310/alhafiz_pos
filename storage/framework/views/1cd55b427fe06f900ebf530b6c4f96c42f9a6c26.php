                                            ...
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <td><input type="number" class="form-control size" name="size[]" value="<?php echo e($product_purchase->size); ?>" step="0.01" required /></td>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="paying_amount" value="<?php echo e($lims_purchase_data->grand_total); ?>" class="form-control" id="paying-amount" step="any" />
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label><strong><?php echo e(trans('file.Paying Amount')); ?> *</strong></label>
                                                <input type="number" value="<?php echo e($lims_purchase_data->paid_amount); ?>" name="paid_amount" class="form-control" id="paid-amount" step="any"/>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
