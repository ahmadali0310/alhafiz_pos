                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                ...
                                <li>
                                    <a href="<?php echo e(route('supplier.edit', ['id'=>$supplier->id])); ?>" class="sedit btn btn-link"><i class="fa fa-edit"></i><?php echo e(trans('file.edit')); ?></a>
                                </li>
                                <li>
                                    <button type="button" data-id="<?php echo e($supplier->id); ?>" class="sdelete btn btn-link"><i class="fa fa-trash"></i></i> <?php echo e(trans('file.delete')); ?></button>
                                </li>
