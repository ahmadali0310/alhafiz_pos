...
<script type="text/javascript">
    ...
    $('select[name="warehouse_id"]').on('change', function() {
        ...
        $.get('getproduct/' + id, function(data) {
            ...
            $.each(product_code, function(index) {
                lims_product_array.push(product_code[index] + ' (' + product_name[index] + ')'+' (' + cost_list[index] + ')');
            });
        });
    });
    ...
    $('button[name="update_btn"]').on("click", function() {
        ...
        var edit_size = $('select[name="edit_size"]').val();
        alert(edit_size);
...
//                });
                ...
                if(flag){
                    ...
                    cols += '<td>' + data[0] + '<button style="display:none" type="button" class="edit-product btn btn-link" data-toggle="modal" data-target="#editModal"> <i class="fa fa-edit"></i></button></td>';
                    cols += '<td>' + data[1] + '</td>';
    ...
    function calculateRowProductData(quantity) {
        ...
        if (tax_method[rowindex] == 1) {
            ...
            // console.log($('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('.unit_price').val());
