                            ...
                            <table id="myTable" class="table table-hover order-list table-fixed">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="col-sm-1"><?php echo e(trans('file.Price')); ?></th>
                                        <th class="col-sm-3"><?php echo e(trans('file.Quantity')); ?></th>
                                        <th class="col-sm-2"><?php echo e(trans('file.size')); ?></th>
...
<script type="text/javascript">
    ...
    $("#myTable").on('input', '.unit_price', function() {
        ...
        // console.log($('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('.net_unit_price').val());
...
//                });
    ...
    function addNewProduct(data){
        ...
        cols += '<td class="col-sm-2 product-title"><strong>' + data[0] + '</strong> [' + data[1] + ']<button type="button" class="edit-product btn btn-link" data-toggle="modal" data-target="#editModal"> <i class="fa fa-edit"></i></button></td>';
        cols += '<td class="col-sm-2 product-price"><input type="number" class="form-control unit_price" step="any" required/></td>';
        ...
        cols += '<td class="col-sm-1 sizes"><select name="size[]" class="form-control size numkey input-number" required>'+sizeDropdown+'</select></td>';
        ...
        cols += '<input type="hidden" class="" name="is_pos" value="1"/>';
    ...
    function calculateRowProductData(quantity) {
        ...
        if (tax_method[rowindex] == 1) {
            ...
            $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('.unit_price').val(sub_total_unit);
            $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('td:nth-child(5)').text(sub_total.toFixed(2));
            $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('td:nth-child(6)').text(sub_cost.toFixed(2));
            $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('.subtotal-value').val(sub_total.toFixed(2));
            $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('.cost-total-value').val(sub_cost.toFixed(2));

            // console.log( $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('td:nth-child(2)').val());
