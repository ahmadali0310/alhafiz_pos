...
//                });
    ...
    function addNewProduct(data){
        ...
        cols += '<td class="col-sm-3 product-title"><strong>' + data[0] + '</strong> [' + data[1] + ']<button type="button" class="edit-product btn btn-link" data-toggle="modal" data-target="#editModal"> <i class="fa fa-edit"></i></button></td>';
        cols += '<td class="col-sm-1 product-price"></td>';
        ...
        cols += '<td class="col-sm-2 sizes"><select name="size[]" class="form-control size numkey input-number" required>'+sizeDropdown+'</select></td>';
