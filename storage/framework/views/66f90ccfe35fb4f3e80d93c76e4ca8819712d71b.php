        ...
        <table id="customer-table" class="table table-striped">
            <thead>
                <tr>
                    ...
                    <th><?php echo e(trans('file.Customer Code')); ?></th>
        ...
        <div class="modal-body">
          <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
            ...
            <div class="form-group">
                ...
                <textarea id="textarea" name="note" rows="4" class="form-control"></textarea>
            </div>
            <input type="submit" onclick="f1();"  value="<?php echo e(trans('file.submit')); ?>" class="btn btn-primary" id="submit-button">
        </div>
        <?php echo Form::close(); ?>
...
var f1 = function () {
    var payment ="اوگراهی";
    $('#textarea').val($('#textarea').val()+payment);
