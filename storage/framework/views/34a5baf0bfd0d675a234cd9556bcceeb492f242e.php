                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select name="supplier_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select Brand...">
                                                <?php $__currentLoopData = $lims_supplier; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supplier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div id="unit" class="col-md-12">
                                    <div class="row ">
                                        ...
                                        <div class="col-md-4">
                                                <label><strong>Sale Sub Unit</strong> </label>
                                                <div class="input-group">
                                                  <select class="form-control selectpicker" name="sale_sub_unit_id" id="sale-sub-unit">
                                                  </select>
                                                  <input type="hidden" name="sale_sub_unit" value="<?php echo e($lims_product_data->sale_sub_unit_id); ?>">
                                              </div>
                                        </div>
                                        <input type="hidden" name="sale_unit_id">
...
<script type="text/javascript">
    ...
    $('select[name="unit_id"]').on('change', function() {
        unitID = $(this).val();
        if(unitID) {
            $('input[name=sale_unit_id]').val(unitID);
    ...
    function populate_unit(unitID){
        $.ajax({
            ...
            success:function(data) {
                  $('select[name="sale_sub_unit_id"]').empty();
                  $('select[name="purchase_unit_id"]').empty();
                  $.each(data, function(key, value) {
                      $('select[name="sale_sub_unit_id"]').append('<option value="'+ key +'">'+ value +'</option>');
