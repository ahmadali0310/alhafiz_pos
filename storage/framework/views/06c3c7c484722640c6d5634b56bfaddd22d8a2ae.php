                                            ...
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php 
                                                        ...
                                                        $sizes = App\ProductPurchase::select('size')->distinct()->where('product_id', $product_return->product_id)->get();
                                                    ...
                                                    ?>
                                                        ...
                                                        <td>
                                                            <select name="size[]" id="" class="form-control size" required>
                                                                <?php $__currentLoopData = $sizes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <option value="<?php echo e($size->size); ?>" <?php echo e($product_return->size == $size->size ? 'selected' : ''); ?> > <?php echo e($size->size); ?></option>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            </select>
                                                        </td>
                                                        ...
                                                        <td style="display: none;" class="sub-cost"><?php echo e(number_format((float)$product_return->total_cost, 2, '.', '')); ?></td>
                                                        ...
                                                        <input type="hidden" class="net_cost_price" name="net_cost_price[]" value="<?php echo e($product_return->net_unit_cost); ?>" />;
                                                        ...
                                                        <input type="hidden" class="cost-total-value" name="costtotal[]" value="<?php echo e($product_return->total_cost); ?>"  />
                                                    </tr>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </tbody>
