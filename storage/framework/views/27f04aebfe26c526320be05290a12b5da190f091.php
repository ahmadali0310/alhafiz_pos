						    ...
						    <table class="table table-bordered table-striped permission-table">
						        ...
						        <tr>
						            ...
						            <td colspan="5">
										...
										<span style="display:inline-block;">
						                    <div class="text-center" aria-checked="false" aria-disabled="false">
					                    	<?php if(in_array("stock-report", $all_permission)): ?>
													<input type="checkbox" value="1" class="checkbox" name="stock-report" checked>
												<?php else: ?>
													<input type="checkbox" value="1" class="checkbox" name="stock-report">
												<?php endif; ?>
						                    </div>
						                    <label for="profit-loss" class="padding05">Stock Report &nbsp;&nbsp;</label>
						                </span>
						                <span style="display:inline-block;">
						                    <div class="text-center" aria-checked="false" aria-disabled="false">
