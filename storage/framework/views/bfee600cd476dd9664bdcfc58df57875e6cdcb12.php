...
<html>
  ...
  <body onload="myFunction()">
            ...
            <ul id="side-main-menu" class="side-menu list-unstyled">                  
              ...
              <li><a href="#sale" aria-expanded="false" data-toggle="collapse"> <i class="icon ion-ios-cart-outline"></i><span><?php echo e(trans('file.Sale')); ?></span></a>
                <ul id="sale" class="collapse list-unstyled ">
                  ...
                  ?>
                  <?php if($add_permission_active): ?>
                  <li><a href="<?php echo e(route('sale.pos')); ?>"><?php echo e(trans('file.pos')); ?></a></li>
              ...
              <li><a href="#report" aria-expanded="false" data-toggle="collapse"> <i class="icon ion-ios-paper-outline"></i><span><?php echo e(trans('file.Reports')); ?></span></a>
                <?php
                  $profit_loss_active = DB::table('permissions')
                        ...
                        ->where([
                          ...
                          ['role_id', $role->id] ])->first();
                  $stock_report_active = DB::table('permissions')
                      ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                      ->where([
                          ['permissions.name', 'stock-report'],
                          ['role_id', $role->id] ])->first();
                ...
                <ul id="report" class="collapse list-unstyled ">
                  ...
                  <?php endif; ?>
                      <?php if($stock_report_active): ?>
                          <li id="stock-report-menu">
                              <?php echo Form::open(['route' => 'report.stock', 'method' => 'post', 'id' => 'stock-report-form']); ?>

                              <input type="hidden" name="warehouse_id" value="1" />
                              <a id="stock-report-link" href="">Stock Report</a>
                              <?php echo Form::close(); ?>
              ...
              <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                ...
                <li class="nav-item">
                      ...
                      <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                          ...
                          <li>
                            <a href="<?php echo e(url('language_switch/ur')); ?>" class="btn btn-link"> اردو</a>
                          </li>
                          <li>
        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-sm-6 text-right">
              <p><?php echo e(trans('file.Developed')); ?> <?php echo e(trans('file.By')); ?> <a href="http://khybercoded.pk" class="external">Khyber Coded</a></p>
            </div>
          </div>
        </div>
      </footer>
    ...
    <script type="text/javascript">
      ...
      $("a#stock-report-link").click(function(e){
          e.preventDefault();
          $("#stock-report-form").submit();
      });
