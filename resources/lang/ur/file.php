...
return [
	...
	"add_product" => "add_pr Prodct",
	"import_product" => "Import_pr productct",
	"print_barcode" => "پرنٹ_بار کوڈ",
	"welcome" => "welcome",
	"profile" => "پروفائل",
	"add" => "شامل",
	"parent" => "والدین",
	...
	"submit" => "جمع",
	"update" => "update",
	"The field labels marked with * are required input fields" => " کے ساتھ  * نشان لگا دیئے گئے فیلڈ لیبل درکار ہیں ان پٹ فیلڈ", 
	"settings" => "",
	"logout" => "",
	"return" => "",
	"profit" => "",
