                                            ...
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <td><input type="number" class="form-control size" name="size[]" value="{{$product_purchase->size}}" step="0.01" required /></td>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="payment_status" class="form-control">
                                                @if($lims_purchase_data->payment_status == 1)
                                                    <option value="1" selected>{{trans('file.Pending')}}</option>
                                                @else
                                                    <option value="1">{{trans('file.Pending')}}</option>
                                                @endif
                                                @if($lims_purchase_data->payment_status == 2)
                                                    <option value="2" selected>{{trans('file.Due')}}</option>
                                                @else
                                                    <option value="2">{{trans('file.Due')}}</option>
                                                @endif
                                                    @if($lims_purchase_data->payment_status == 3)
                                                        <option value="3" selected>{{trans('file.Partial')}}</option>
                                                    @else
                                                        <option value="3">{{trans('file.Partial')}}</option>
                                                    @endif

                                                    @if($lims_purchase_data->payment_status == 4)
                                                        <option value="4" selected>{{trans('file.Paid')}}</option>
                                                    @else
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="paying_amount" value="{{$lims_purchase_data->grand_total}}" class="form-control" id="paying-amount" step="any" />
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label><strong>{{trans('file.Paying Amount')}} *</strong></label>
                                                <input type="number" value="{{$lims_purchase_data->paid_amount}}" name="paid_amount" class="form-control" id="paid-amount" step="any"/>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
...
var lims_product_code = [
    ...
    //Change size
    $("#myTable").on('input', '.size', function() {
        rowindex = $(this).closest('tr').index();
        var qty = $(".qty").val();
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if(flag){
                ...
                cols += '<td><input type="number" class="form-control size" name="size[]" step="0.01" required value="0"/></td>';
...
function checkQuantity(purchase_qty,size, flag) {
    var row_product_code = $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('td:nth-child(2)').text();
    ...
    $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('.size').val(size);
    var status = $('select[name="status"]').val();
    if(status == '1' || status == '2' )
        $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('.recieved').val(purchase_qty);
    var qty = purchase_qty * size;
    console.log(qty);
...
function calculateRowProductData(quantity) {
    ...
    console.log($('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('td:nth-child(6)'));
    console.log((product_discount[rowindex] * quantity));
    ...
    if (tax_method[rowindex] == 1) {
        ...
        console.log("THis is if"+row_product_cost, product_discount[rowindex], (tax_rate[rowindex] / 100));

        $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('td:nth-child(6)').text(net_unit_cost.toFixed(2));
        $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('.net_unit_cost').val(net_unit_cost.toFixed(2));
        $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('td:nth-child(8)').text(tax.toFixed(2));
        $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('.tax-value').val(tax.toFixed(2));
        $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('td:nth-child(9)').text(sub_total.toFixed(2));
        ...
        console.log("THis is not if"+sub_total_unit,net_unit_cost, tax, sub_total);
