...
{{--						<p class="mt-2">{{trans('file.Purchase')}} <span class="float-right">- {{number_format((float)$purchase[0]->grand_total, 2, '.', '')}}</span></p>--}}
						<p class="mt-2">{{trans('file.profit')}} <span class="float-right">{{number_format((float)($profit), 2, '.', '') }}</span></p>
					</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="colored-box">
					...
					<div class="mt-3">
						<p class="mt-2">{{trans('file.Sale')}} <span class="float-right">{{number_format((float)$sale[0]->grand_total, 2, '.', '')}}</span></p>
						<p class="mt-2">{{trans('file.Sale Return')}} <span class="float-right">- {{number_format((float)$return1, 2, '.', '')}}</span></p>
						<p class="mt-2"> Revenue <span class="float-right"> {{number_format((float)$revenue1, 2, '.', '')}}</span></p>
						<p class="mt-2">{{trans('file.Expense')}}<span class="float-right"> {{number_format((float)$expense1, 2, '.', '')}}</span></p>
						<p class="mt-2">{{trans('file.profit')}} <span class="float-right"> {{number_format((float)($profit), 2, '.', '') }}</span></p>
					</div>
				</div>
			</div>
