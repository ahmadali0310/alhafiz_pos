                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <select name="size[]" id="" class="form-control size" required>
                                                                ...
                                                                <option value="{{$size->size}}" {{$product_sale->size == $size->size ? 'selected' : '' }} > {{$size->size}}</option>
                                                                @endforeach
                                                            </select>
                                                        </td>
                                                        ...
                                                        <td style="display: none;" class="sub-cost">{{ number_format((float)$product_sale->total_cost, 2, '.', '') }}</td>
                                                        ...
                                                        <input type="hidden" class="net_unit_price" name="net_unit_price[]" value="{{$product_sale->net_unit_price}}" />
                                                         <input type="hidden" class="net_cost_price" name="net_cost_price[]" value="{{$product_sale->net_unit_cost}}" />;
                                                        ...
                                                        <input type="hidden" class="cost-total-value" name="costtotal[]" value="{{$product_sale->total_cost}}"  />
                                                    </tr>
                                                    @endforeach
                                                </tbody>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="total_cost" value="{{$lims_sale_data->total_cost}}" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="paying_amount" value="{{$lims_sale_data->grand_total}}" class="form-control" id="paying-amount" step="any" />
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label><strong>{{trans('file.Paying Amount')}} *</strong></label>
                                                <input type="number" value="{{$lims_sale_data->paid_amount}}" name="paid_amount" class="form-control" id="paid-amount" step="any"/>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
