                                            ...
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <td>
                                                            <select name="size[]" id="" class="form-control size" required>
                                                                @foreach($sizes as $size)
                                                                    <option value="{{$size->size}}" {{$product_return->size == $size->size ? 'selected' : '' }} > {{$size->size}}</option>
                                                                @endforeach
                                                            </select>
                                                        </td>
                                                        ...
                                                        <td style="display: none;" class="sub-cost">{{ number_format((float)$product_return->total_cost, 2, '.', '') }}</td>
                                                        ...
                                                        <input type="hidden" class="net_cost_price" name="net_cost_price[]" value="{{$product_return->net_unit_cost}}" />;
                                                        ...
                                                        <input type="hidden" class="cost-total-value" name="costtotal[]" value="{{$product_return->total_cost}}"  />
                                                    </tr>
                                                    @endforeach
                                                </tbody>
