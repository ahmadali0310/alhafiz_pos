                ...
                <div class="table-responsive mb-4">
                    <table id="account-table" class="table table-hover">
                        ...
                        <tbody>
                            ...
                            @php $balance = $balance + $credit->amount + $credit->change; @endphp
                            <tr>
                                <td>{{$key}}</td>
                                ...
                                <td>{{number_format((float)$credit->change, 2, '.', '')}}</td>
                                <td>{{number_format((float)$balance, 2, '.', '')}}</td>
                            </tr>
                            @endforeach

                            @foreach($debit_list as $key=>$debit)
                            @php $balance =  ($balance + $debit->amount) -  $debit->change; @endphp
                            <tr>
                                <td>{{$key}}</td>
                                ...
                                <td>{{number_format((float)$debit->change, 2, '.', '')}}</td>
                                <td>{{number_format((float)$balance, 2, '.', '')}}</td>
                            </tr>
                            @endforeach
