...
{{--                  <li id="sale-import-menu"><a href="{{url('sales/sale_by_csv')}}">{{trans('file.Import Sale By CSV')}}</a></li>--}}
              ...
              <li><a href="#report" aria-expanded="false" data-toggle="collapse"> <i class="icon ion-ios-paper-outline"></i><span>{{trans('file.Reports')}}</span></a>
                ...
                <ul id="report" class="collapse list-unstyled ">
                  ...
                  @endif
                      @if($stock_report_active)
                          <li id="stock-report-menu">
                              {!! Form::open(['route' => 'report.stock', 'method' => 'post', 'id' => 'stock-report-form']) !!}
              ...
              <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                ...
                <li class="nav-item">
                      ...
                      <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                          ...
                          <li>
                            <a href="{{ url('language_switch/ur') }}" class="btn btn-link"> اردو</a>
                          </li>
                          <li>
        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-sm-6 text-right">
              <p>{{trans('file.Developed')}} {{trans('file.By')}} <a href="http://khybercoded.pk" class="external">Khyber Coded</a></p>
            </div>
          </div>
        </div>
      </footer>
