...
class ProductController extends Controller
{
    ...
    public function create()
    {
        ...
        if ($role->hasPermissionTo('products-add')){
            ...
            $lims_supplier = Supplier::where('is_active', true)->get();
            return view('product.create',compact('lims_supplier' ,'lims_product_list', 'lims_brand_list', 'lims_category_list', 'lims_unit_list', 'lims_tax_list'));
        }
        else
            return redirect()->back()->with('not_permitted', 'Sorry! You are not allowed to access this module');
    }
...
//            return dd($lims_product_variant_data);
            ...
            return view('product.edit',compact('lims_supplier','lims_product_list', 'lims_brand_list', 'lims_category_list', 'lims_unit_list', 'lims_tax_list', 'lims_product_data', 'lims_product_variant_data'));
        }
        else
            return redirect()->back()->with('not_permitted', 'Sorry! You are not allowed to access this module');
    }
...
//        return $lims_product_data;
    ...
    public function destroy($id)
    {
        ...
        if($lims_product_data->image) {
            ...
            foreach ($images as $key => $image) {
                if(is_file(public_path('images/product/' . $image))){
