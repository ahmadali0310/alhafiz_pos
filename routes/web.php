...
Route::group(['middleware' => ['auth', 'active']], function() {
    ...
    Route::get('supplier/getDeposit/{id}', 'SupplierController@getDeposit');
    Route::post('supplier/add_deposit', 'SupplierController@addDeposit')->name('supplier.addDeposit');
	...
	Route::get('sales/gen_invoice_pos/{id}/', 'SaleController@genInvoicePos')->name('sale.posInvoice');
	...
	Route::get('purchases/getproduct/{id}', 'PurchaseController@getProduct');
	...
	Route::get('return-purchase/getproduct/{id}/{sup_id}', 'ReturnPurchaseController@getProduct')->name('return-purchase.getproduct');
	...
	Route::post('report/stock_report', 'ReportController@stockReport')->name('report.stock');
